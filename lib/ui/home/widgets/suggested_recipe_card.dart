...
import 'package:recipes_app/ui/home/widgets/diets_chips.dart';
...
class SuggestedRecipeCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final stepsString =
        (state.recipes?[index].analyzedInstructions?[0].steps?.length ?? 0) > 1
            ? "Steps"
            : "Step";
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Chip(
                        ...
                        label: Text(
                            "${state.recipes?[index].analyzedInstructions?[0].steps?.length.toString()} $stepsString"),
                      ),
                      DietsChips(
                        state: state,
                        index: index,
